// The quotes, days, and action items will have changes stored in arrays
...
// quotes, days, and action items will all change from clicking the button
// would make sense for all of the innerHTML changes to occur in the same function
